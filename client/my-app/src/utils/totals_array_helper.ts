...
export const resetValues = (editMealTotals: totalsArray) : totalsArray => {
  ...
  export const incrementValue = (newFood: foodStatsItem, editMealTotals: totalsArray) : totalsArray => {
    const currentTotals = editMealTotals;
  ...
  export const decrementValue = (newFood: foodStatsItem | null, editMealTotals: totalsArray) : totalsArray => {
    if (newFood !== null) {
      const currentTotals = editMealTotals;
      currentTotals.calories -= newFood.nf_calories;
      currentTotals.totalFat -= newFood.nf_total_fat;
