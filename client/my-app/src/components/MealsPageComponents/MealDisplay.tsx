...
const MealDisplay = ({ loggedInUser }: MealsPageProps) => {
  ...
  const [editMealSelections, setEditMealSelections] = useState(Array<foodSearchItem>());
      ...
      <>
       <div className={styles.selectionsColumn}>
          ...
          <div className={styles.selectionButton}>
            <Button size="lg" variant="primary" onClick={() => setIsEditMode(true)}>
              Edit
            </Button>
            ...
            return (
              <div className={styles.selectionsRowSingle}>
                <Figure>
                  ...
                  />
                  <Figure.Caption style={{ textTransform: "capitalize" }}>
                    {selection.food_name}
                  </Figure.Caption>
                </Figure>
              </div>
